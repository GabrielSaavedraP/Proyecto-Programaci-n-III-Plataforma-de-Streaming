            ...
            if (resultados.empty()) {
                ...
                do {
                    vector<Resultado> pagina =
                            trie.obtenerPagina(resultados, paginaActual, 5);
                    cout << "\n====================================\n";
                    cout << " RESULTADOS - PAGINA " << paginaActual << endl;
                    cout << "====================================\n";
                    cout << "Total encontrados: " << resultados.size() << "\n\n";
                    for (int i = 0; i < (int)pagina.size(); i++) {
                        ...
                        cout << i + 1 << ". "
                             ...
                             << pelis[id].genero
                             << " | Relevancia: " << pagina[i].relevancia
                             << endl;
                    }
                    cout << "\nOpciones:\n";
                    ...
                    if (accion >= '1' && accion <= '5') {
                        ...
                        if (indice < (int)pagina.size()) {
                            ...
                            do {
                                ...
                                cout << "Anio: " << pelis[id].releaseYear << endl;
                        ...
                        vector<Resultado> siguiente =
                                trie.obtenerPagina(resultados, paginaActual + 1, 5);
                        if (!siguiente.empty()) {
                            paginaActual++;
                        } else {
